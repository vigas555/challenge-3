...
export const createAttendeeCollection = async (
  ...
  const result = await sdk.collections.creation.submitWaitResult({
    ...
    schema: {
      ...
      // collection image
      coverPicture: {
        url: "https://gateway.pinata.cloud/ipfs/QmSMPWS6MY58ByV9W3YXnZJfSkXmfWwsdc3AQu6TPE5hme?_gl=1*1fz5nsr*rs_ga*MTAwODc5MTgwOS4xNjg0ODUwMzQz*rs_ga_5RMPXG14TE*MTY4NjA2MTMzMC4yLjEuMTY4NjA2MTY5MS41Ni4wLjA.",
      },
